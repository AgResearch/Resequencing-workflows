...
help_text="
 examples : \n
 ./ResequencingWF1.4.sh  -n -S Sample_932593 -D /dataset/hiseq/active/140516_D00390_0041_BC4KPCACXX/bcl2fastq/Unaligned/Project_SalmonSheepWGS/Sample_932593 -G /dataset/Salmo_salar_2014/active/ICSASG_v1/Ssa_ASM_3.6.fa  -B /dataset/Salmo_salar_2014/scratch  -p 9 -q 1 -r 2 -s _R -t _0\n
...
make -i -f ResequencingWF1.4.mk ${SAMPLE}.logprecis 
# prepare a listing of software versions
make -i -f ResequencingWF1.4.mk ${SAMPLE}.versions 
